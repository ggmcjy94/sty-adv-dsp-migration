...
import com.example.legacy.domain.campaign.event.LegacyCampaignBudgetUpdatedEvent;
import com.example.legacy.domain.campaign.event.LegacyCampaignCreatedEvent;
import com.example.legacy.domain.campaign.event.LegacyCampaignDeletedEvent;
import com.example.legacy.domain.campaign.event.LegacyCampaignNameUpdatedEvent;
